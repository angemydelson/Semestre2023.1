...
Grafo::Grafo(int num_vertices) {
    ...
    for (auto i = 0; i < num_vertices; i++) { // ou i < matriz_adj_.size()
...
void Grafo::imprime() {
    for (auto v = 0; v < num_vertices_; v++) { // ou v < matriz_adj_.size()
        cout << v << ":";
        for (auto u = 0; u < num_vertices_; u++) { // ou u < matriz_adj_.size()
